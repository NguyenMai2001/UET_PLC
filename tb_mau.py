...
def check(mean):
    ...
    start_row,start_col= 533,745
    end_row,end_col= 697,1030
...
tb=0
for i in range(100):
    file_name = "Camera_test/w3/w3 (" + str(i+1) + ").jpg"
    ...
    value_in = 22435
    value_out = check(img)
    if value_out < (value_in - 100) or value_out > (value_in + 100) :
        # print("true") #co lech
        # print("annh thu ", i) #có lệch
...
print("trung binh gt diem anh: ", tb/50)
