...
#==================================
    ...
    def update_data_check(self, data):
        ...
        while self.result[self.count] != 1:
            self.count += 1
        ...
        tray_NG_idx = (self.count-self.number_success) // 48
        ...
        if data == "Ok_for_jig":
            ...
            if tray_idx < 2:
                ...
                self.tray3[tray_idx-2].item(row,col).setBackground(QColor(67, 138, 94))
        else:
            if tray_NG_idx ==0 :
                if data == "NG":
                    ...
                    error1.setTextAlignment(Qt.AlignCenter)
                    self.tray2[2].setItem(row, col, error1)
                    self.tray2[2].item(row,col).setBackground(QColor(232, 80, 91))
