...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.cam2_name.setGeometry(1050 * self.width_rate, 127 * self.height_rate, 810 * self.width_rate, 60 * self.height_rate)
        ...
        self.cam2.setGeometry(1050 * self.width_rate, 185 * self.height_rate, 810 * self.width_rate, 400 * self.height_rate)
        ...
        for i in range(2):
            ...
            tray_name.setGeometry((55 + 490*i - 5) * self.width_rate, 606 * self.height_rate, 474 * self.width_rate, 55 * self.height_rate)
            tray_name.setAlignment(Qt.AlignCenter)
            tray_name.setStyleSheet("background-color:rgb(50, 130, 184);"
                                    "color: rgb(255, 255, 255);"
                                    "font: bold 14pt;")
            table_margin = QLabel(self)
            table_margin.setGeometry((55 + 490*i - 5) * self.width_rate, 661 * self.height_rate, 474 * self.width_rate, 405 * self.height_rate)
            table_margin.setStyleSheet("border-color: rgb(50, 130, 184);"
                                        "border-width: 5px;"
                                        "border-style: inset;")
            table = QTableWidget(6, 8, self)
            table.setGeometry((55 + 490*i) * self.width_rate, 666 * self.height_rate, int(465 * self.width_rate) + 1, int(397 * self.height_rate) -4)
            table.horizontalHeader().hide()
            table.verticalHeader().hide()
            for j in range(8):
                table.setColumnWidth(j, 25 * self.width_rate)
            for j in range(6):
                table.setRowHeight(j, 65 * self.height_rate)
        ...
        self.tray2 = []
        for i in range(2):
            tray_name = QLabel("TRAY {}".format(i+2), self)
            tray_name.setGeometry((55 + 490*i - 5) * self.width_rate, 127 * self.height_rate, 474 * self.width_rate, 55 * self.height_rate)
            tray_name.setAlignment(Qt.AlignCenter)
            tray_name.setStyleSheet("background-color:rgb(50, 130, 184);"
                                    "color: rgb(255, 255, 255);"
                                    "font: bold 14pt;")
            table_margin = QLabel(self)
            table_margin.setGeometry((55 + 490*i - 5) * self.width_rate, 181 * self.height_rate, 474 * self.width_rate, 405 * self.height_rate)
            table_margin.setStyleSheet("border-color: rgb(50, 130, 184);"
                                        "border-width: 5px;"
                                        "border-style: inset;")
            table = QTableWidget(6, 8, self)
            table.setGeometry((55 + 490*i) * self.width_rate, 186 * self.height_rate, int(465 * self.width_rate) + 1, int(397 * self.height_rate) -4)
            table.horizontalHeader().hide()
            table.verticalHeader().hide()
            for j in range(8):
                table.setColumnWidth(j, 25 * self.width_rate)
        ...
        self.s_name.setGeometry(1035 * self.width_rate, 605 * self.height_rate, 399 * self.width_rate, 60 * self.height_rate)
        self.s_name.setAlignment(Qt.AlignCenter)
        self.s_name.setStyleSheet("background-color:rgb(50, 130, 184);"
                                    "color: rgb(255, 255, 255);"
                                    "font: bold 14pt;")
        self.textBox = QPlainTextEdit(self)
        self.textBox.setGeometry(1035 * self.width_rate, 663 * self.height_rate, 399 * self.width_rate, 180 * self.height_rate)
        ...
        self.s_name.setGeometry(1035 * self.width_rate, 850 * self.height_rate, 399 * self.width_rate, 60 * self.height_rate)
        ...
        self.note_table.setGeometry(1035 * self.width_rate, 903 * self.height_rate, 399 * self.width_rate, 162 * self.height_rate)
